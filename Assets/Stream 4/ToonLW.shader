    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag (GraphVertexOutput IN ) : SV_Target
            {
				...
				float3 Color = ( _Dimming * temp_output_58_0 ).rgb;
				float Alpha = 1;
        ...
        Pass
        {
            ...
            half4 frag (GraphVertexOutput IN ) : SV_Target
            {
				...
				float3 Color = ( temp_output_58_0 + ( float4( lerpResult53 , 0.0 ) * smoothstepResult48 * _RimColor ) ).rgb;
				float Alpha = 1;
				float AlphaClipThreshold = 0.5;
...
/*ASEBEGIN
Version=17705
323;432;1413;738;4296.957;1778.414;4.220135;True;True
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;181;304,-160;Float;False;True;-1;2;ASEMaterialInspector;0;3;Amplify Streams 4/Toon LW;e2514bdcf5e5399499a9eb24d175b9db;True;Base;0;1;Base;5;False;False;False;True;0;False;-1;False;False;False;False;False;True;3;RenderPipeline=LightweightPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;2;0;True;1;1;False;-1;0;False;-1;1;1;False;-1;0;False;-1;False;False;False;True;True;True;True;True;0;False;-1;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=LightweightForward;False;0;Hidden/InternalErrorShader;0;0;Standard;9;Surface;0;  Blend;0;Two Sided;1;Cast Shadows;1;Receive Shadows;1;Built-in Fog;0;LOD CrossFade;0;Extra Pre Pass;1;Vertex Position,InvertActionOnDeselection;1;0;4;True;True;True;True;False;;0
...
WireConnection;180;3;105;0
ASEEND*/
//CHKSM=585C79B31B7FC03F1EA17D4F56B66EA5B560D955